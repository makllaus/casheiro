    ...
    */
    ...
    public static function get_settings()
    {
        $settings = array(
            ...
            'request_logging' => array(
                'name' => __('Loyaltybox Log Files', 'woocommerce-settings-tab-loyaltybox'),
                'type' => 'checkbox',
                'default' => 'no',
                'show_if_checked' => 'option',
                'desc' => __( 'Request logging', 'woocommerce-settings-tab-demo' ),
                'id' => 'wc_settings_tab_loyaltybox_request_logging',
            ),
            'error_logging' => array(
                'type' => 'checkbox',
                'default' => 'no',
                'show_if_checked' => 'option',
                'desc' => __( 'Error logging', 'woocommerce-settings-tab-demo' ),
                'id' => 'wc_settings_tab_loyaltybox_error_logging',
            ),
            'plugin_logging' => array(
                'type' => 'checkbox',
                'default' => 'no',
                'show_if_checked' => 'option',
                'desc' => __( 'Plugin logging', 'woocommerce-settings-tab-demo' ),
                'id' => 'wc_settings_tab_loyaltybox_plugin_logging',
            ),
        );
