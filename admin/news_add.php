...
if (isset($_POST['action']) && $_POST['action'] == "add_news")
{
	...
	$news_description	= mysql_real_escape_string(nl2br(getPostParameter('news_description')));
...
?>
        ...
        <form action="" method="post">
          ...
          <tr>
            ...
            <td valign="top"><input type="text" name="news_title" id="news_title" value="<?php echo getPostParameter('news_title'); ?>" size="45" class="textbox" /></td>
          </tr>
          <tr>
            <td valign="middle" align="right" class="tb1">Description:</td>
            <td valign="top"><textarea name="news_description" cols="75" rows="12" class="textbox2"><?php echo getPostParameter('news_description'); ?></textarea></td>
          </tr>
          <tr>
