...
?>
		...
		<td nowrap="nowrap" width="65%" valign="middle" align="left">
				  ...
				  <tr class="<?php if (($cc%2) == 0) echo "even"; else echo "odd"; ?>">
					...
					<td align="left" valign="middle" class="row_title">
						<div style="margin: 5px 0;">
							...
							<div style="float: right; color: #8E8E8E;"><?php echo $row['date_added']; ?></div>
						</div>
						...
						<?php 
							if (strlen($row['review']) > 350)
								...
								echo $row['review'];
						?>
						<div style="width: 100%; font-size: 10px; border-top: 1px dotted #EEE; padding: 3px 0; margin: 3px 0;">
					...
					<td nowrap="nowrap" align="center" valign="middle">
						<a href="review_details.php?id=<?php echo $row['review_id']; ?>&pn=<?php echo $page; ?>&column=<?php echo $_GET['column']; ?>&order=<?php echo $_GET['order']; ?>" title="View"><img src="images/view.gif" border="0" alt="View" /></a>
						<a href="review_edit.php?id=<?php echo $row['review_id']; ?>&pn=<?php echo $page; ?>&column=<?php echo $_GET['column']; ?>&order=<?php echo $_GET['order']; ?>" title="Edit"><img src="images/edit.gif" border="0" alt="Edit" /></a>
						<a href="#" onclick="if (confirm('Are You sure You realy want to delete this review?') )location.href='review_delete.php?id=<?php echo $row['review_id']; ?>&column=<?php echo $_GET['column']; ?>&order=<?php echo $_GET['order']; ?>&pn=<?php echo $page?>'" title="Delete"><img src="images/delete.gif" border="0" alt="Delete" /></a>
					</td>
				  </tr>
			<?php } ?>
				<tr>
          ...
          <?php }else{ ?>
				<?php if (isset($filter)) { ?>
					<div class="info_box">No reviews found. <a href="reviews.php">Search again &#155;</a></div>
				<?php }else{ ?>
					<div class="info_box">There are no reviews at this time. <a href="#" onclick="history.go(-1);return false;">Go Back &#155;</a></div>
				<?php } ?>
          <?php } ?>
