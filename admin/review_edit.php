	...
	<?php } ?>
      ...
      <form action="" method="post" name="form1">
        <table width="100%" cellpadding="2" cellspacing="5" border="0" align="center">
          ...
          <tr>
            <td width="30%" valign="middle" align="right" class="tb1"><span class="req">* </span>Rating:</td>
            <td width="70%" valign="top">
				<select name="rating">
					<option value="">---------</option>
          ...
          <tr>
            <td width="30%" valign="middle" align="right" class="tb1"><span class="req">* </span>Review Title:</td>
            ...
            <tr>
				<td valign="middle" align="right" class="tb1"><span class="req">* </span>Review:</td>
