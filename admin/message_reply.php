		...
		<form action="" method="post" name="form1">
          <table width="550" align="center" cellpadding="5" cellspacing="5" border="0">
            <tr>
              ...
              <td width="80%" valign="top"><a href="user_details.php?id=<?php echo $row['user_id']; ?>" class="user"><?php echo $row['fname']." ".$row['lname']; ?></a></td>
            </tr>
            <tr>
           ...
           <tr>
            ...
            <td align="left" valign="top"><textarea cols="64" rows="5" name="answer" class="textbox2"><?php echo getPostParameter('answer'); ?></textarea></td>
          </tr>
          <tr>
