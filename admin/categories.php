...
\*******************************************************************/
	...
	$query = "SELECT * FROM cashbackengine_categories ORDER BY name";
...
?>
        ...
        <?php if ($total > 0) { ?>
			...
			<table align="center" style="border-bottom: 1px solid #DCEAFB;" width="60%" border="0" cellpadding="3" cellspacing="0">
			<tr>
             ...
             <?php $allcategories = array(); $allcategories = CategoriesList(0); foreach ($allcategories as $category_id => $category_name) { $cc++; ?>
				  <tr class="<?php if (($cc%2) == 0) echo "even"; else echo "odd"; ?>">
					...
					<td nowrap="nowrap" align="center" valign="middle">
						<a href="category_edit.php?id=<?php echo $category_id; ?>" title="Edit"><img border="0" alt="Edit" src="images/edit.gif" /></a>
						<a href="#" onclick="if (confirm('Are You sure You realy want to delete this category?') )location.href='category_delete.php?id=<?php echo $category_id; ?>'" title="Delete"><img border="0" alt="Delete" src="images/delete.gif" /></a>
					</td>
				  </tr>
			<?php } ?>
            </table>
