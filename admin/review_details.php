          ...
          <tr>
            ...
            <tr>
              <td align="center" colspan="2" valign="bottom">
				...
				<input type="button" class="submit" name="cancel" value="Go Back" onClick="javascript:document.location.href='reviews.php?page=<?php echo $pn; ?>&column=<?php echo $_GET['column']; ?>&order=<?php echo $_GET['order']; ?>'" />
			  </td>
            </tr>
          </table>
