...
?>
        ...
        <?php if ($total > 0) { ?>
			...
			<table align="center" style="border: 1px dotted #DCEAFB;" width="400" border="0" cellpadding="5" cellspacing="0">
			<tr>
             ...
             <?php while ($row = mysql_fetch_array($result)) { ?>
				 <tr>
					...
					<td nowrap="nowrap" style="border-bottom: 1px #DCEAFB dotted;" align="center" valign="middle">
						<a href="affnetwork_edit.php?id=<?php echo $row['network_id']; ?>" title="Edit"><img src="images/edit.gif" border="0" alt="Edit" /></a>
						<a href="#" onclick="if (confirm('Are You sure You realy want to delete this affiliate network?') )location.href='affnetwork_delete.php?id=<?php echo $row['network_id']; ?>'" title="Delete"><img src="images/delete.gif" border="0" alt="Delete" /></a>
					</td>
				  </tr>
			<?php } ?>
            </table>
