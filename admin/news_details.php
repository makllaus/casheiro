...
\*******************************************************************/
	...
	if (isset($_GET['id']) && is_numeric($_GET['id']))
	{
		...
		$query = "SELECT *, DATE_FORMAT(added, '%e %b %Y %h:%i %p') AS modify_date FROM cashbackengine_news WHERE news_id='$news_id'";
...
?>   
      ...
      <?php if ($total > 0) { ?>
          ...
          <tr>
			...
			<input type="button" class="submit" name="cancel" value="Go Back" onClick="javascript:document.location.href='news.php'" />
		  </td>
          </tr>
