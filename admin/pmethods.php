...
?>
        ...
        <?php if ($total > 0) { ?>
			...
			<table align="center" width="50%" style="border-bottom: 1px solid #DCEAFB;" border="0" cellpadding="3" cellspacing="0">
			<tr>
             ...
             <?php while ($row = mysql_fetch_array($result)) { $cc++; ?>		  
				  <tr class="<?php if (($cc%2) == 0) echo "even"; else echo "odd"; ?>">
					...
					<td nowrap="nowrap" align="center" valign="middle">
						<a href="pmethod_edit.php?id=<?php echo $row['pmethod_id']; ?>" title="Edit"><img src="images/edit.gif" border="0" alt="Edit" /></a>
						<a href="#" onclick="if (confirm('Are You sure You realy want to delete this payment method?') )location.href='pmethod_delete.php?id=<?php echo $row['pmethod_id']; ?>'" title="Delete"><img src="images/delete.gif" border="0" alt="Delete" /></a>
					</td>
				  </tr>
			<?php } ?>
            </table>
