...
if (isset($_POST['action']) && $_POST['action'] == "editnetwork")
{
	...
	if (count($errs) == 0)
	{
		$sql = "UPDATE cashbackengine_affnetworks SET csv_format='$csv_format', confirmeds='$confirmeds', pendings='$pendings', declineds='$declineds', status='$status' WHERE network_id='$network_id' LIMIT 1";
...
?>
      ...
      ?>
		...
		<?php if ($row['image'] != "") { ?>
          <tr>
            <td colspan="2" valign="middle" align="center"><img src="images/networks/<?php echo $row['image']; ?>" " alt="<?php echo $row['network_name']; ?>" title="<?php echo $row['network_name']; ?>" border="0" /></td>
          </tr>
		<?php }else{ ?>
          <tr>
		...
		<?php } ?>
          ...
          <tr>
            ...
            <td valign="top"><textarea cols="90" rows="1" wrap="off" style="padding-top:5px;" name="csv_format" class="textbox2"><?php echo stripslashes($row['csv_format']); ?></textarea></td>
          </tr>
          <tr>
				...
				<table bgcolor="#F7F7F7" style="border: 1px solid #DDDDDD" width="100%" align="left" cellpadding="2" cellspacing="5" border="0">
					<tr>
						<td align="center" valign="top">
							...
							<textarea wrap="off" cols="20" rows="2" style="padding-top:5px;" name="confirmeds" class="textbox2"><?php echo str_replace("|", "\r\n", $row['confirmeds']); ?></textarea>
						<td>
						<td align="center" valign="top">
							<font color="#F37007"><b>Pending</b></font><br/><br/>
							<textarea wrap="off" cols="20" rows="2" style="padding-top:5px;" name="pendings" class="textbox2"><?php echo str_replace("|", "\r\n", $row['pendings']); ?></textarea>
						<td>
						<td align="center" valign="top">
							<font color="#FF000A"><b>Declined</b></font><br/><br/>
							<textarea wrap="off" cols="20" rows="2" style="padding-top:5px;" name="declineds" class="textbox2"><?php echo str_replace("|", "\r\n", $row['declineds']); ?></textarea>
						<td>
					</tr>
				</table>
			</td>
      ...
      <?php }else{ ?>
				<p align="center">Sorry, no network found.<br/><br/><a class="goback" href="#" onclick="history.go(-1);return false;">Go Back</a></p>
      <?php } ?>
