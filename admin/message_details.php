...
?>   
	...
	?>
	   ...
	   <h2>View Message</h2>
		...
		<form action="" method="post" name="form1">
          <table width="550" align="center" cellpadding="5" cellspacing="5" border="0">
            ...
            <tr>
              ...
              <td nowrap="nowrap" valign="top"><?php echo $row['message_date']; ?></td>
            </tr>
           <tr>
            <td nowrap="nowrap" valign="middle" align="right" class="tb2">Message:</td>
            <td height="70" style="border: 1px solid #EEE; border-radius: 5px;" valign="top"><?php echo $row['message']; ?></td>
          </tr>
		<?php
		...
		?>
				<tr><div class="message_date"><td nowrap="nowrap" valign="middle" align="right" class="tb2"><?php echo $sender; ?> Reply:</td><td bgcolor="<?php echo $bg; ?>" style="border: 1px solid #EEE;" valign="top"><div align="right"><small><font color="#A7A7A7"><?php echo $arow['a_date']; ?></font></small></div><?php echo $arow['answer']; ?></td></tr>
		...
		<?php }	?>
          ...
          <td colspan="2" align="center" valign="bottom">
			...
			<input type="button" class="submit" name="cancel" value="Go Back" onClick="javascript:document.location.href='messages.php'" />
		  </td>
          </tr>
          </table>
		</form>
